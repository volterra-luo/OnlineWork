...
def transform(name, data, schema):
    ...
    * alter field   --- ``data['xxx'] = f(data['xxx'])``
    ...
    For example, if the application is ``onlinelab.sdk.models``, the
    ...
    this::
        ...
        def transform_0_onlinelab_sdk_models_Worksheet(data):
            pass
...
def transform_0_onlinelab_sdk_models_Cell(data):
